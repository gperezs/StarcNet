...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv8 = nn.Conv2d(128, 128*self.a1, kernel_size=3, padding=1)
        self.bn8 = nn.GroupNorm(n,128*self.a1)
        self.relu8 = nn.LeakyReLU()
        self.conv11 = nn.Conv2d(128*self.a1, 128*self.a1, kernel_size=3, padding=1)
        self.bn11 = nn.GroupNorm(n,128*self.a1)
        self.relu11 = nn.LeakyReLU()
        self.conv12 = nn.Conv2d(128*self.a1, 128*self.a1, kernel_size=3, padding=1)
        self.bn12 = nn.GroupNorm(n,128*self.a1)
        self.relu12 = nn.LeakyReLU()
        self.fc1 = nn.Linear(128*self.a1*int(self.sz1/2)*int(self.sz1/2), 128)
        ...
        self.aconv1 = nn.Conv2d(5, 128*self.a21, kernel_size=3, padding=1)
        self.abn1 = nn.GroupNorm(n,128*self.a21)
        self.arelu1 = nn.LeakyReLU()
        self.aconv3 = nn.Conv2d(128*self.a21, 128*self.a21, kernel_size=3, padding=1)
        self.abn3 = nn.GroupNorm(n,128*self.a21)
        self.arelu3 = nn.LeakyReLU()
        self.aconv4 = nn.Conv2d(128*self.a21, 128*self.a21, kernel_size=3, padding=1)
        self.abn4 = nn.GroupNorm(n,128*self.a21)
        self.arelu4 = nn.LeakyReLU()
        self.aconv7 = nn.Conv2d(128*self.a21, 128*self.a21, kernel_size=3, padding=1)
        self.abn7 = nn.GroupNorm(n,128*self.a21)
        self.arelu7 = nn.LeakyReLU()
        self.apool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        self.aconv8 = nn.Conv2d(128*self.a21, 128*self.a2, kernel_size=3, padding=1)
        self.abn8 = nn.GroupNorm(n,128*self.a2)
        self.arelu8 = nn.LeakyReLU()
        self.aconv11 = nn.Conv2d(128*self.a2, 128*self.a2, kernel_size=3, padding=1)
        self.abn11 = nn.GroupNorm(n,128*self.a2)
        self.arelu11 = nn.LeakyReLU()
        self.aconv12 = nn.Conv2d(128*self.a2, 128*self.a2, kernel_size=3, padding=1)
        self.abn12 = nn.GroupNorm(n,128*self.a2)
        self.arelu12 = nn.LeakyReLU()
        self.afc1 = nn.Linear(128*self.a2*int(self.sz1/2)*int(self.sz1/2), 128)
        ...
        self.aaconv8 = nn.Conv2d(128, 128*self.a3, kernel_size=3, padding=1)
        self.aabn8 = nn.GroupNorm(n,128*self.a3)
        self.aarelu8 = nn.LeakyReLU()
        self.aaconv11 = nn.Conv2d(128*self.a3, 128*self.a3, kernel_size=3, padding=1)
        self.aabn11 = nn.GroupNorm(n,128*self.a3)
        self.aarelu11 = nn.LeakyReLU()
        self.aaconv12 = nn.Conv2d(128*self.a3, 128*self.a3, kernel_size=3, padding=1)
        self.aabn12 = nn.GroupNorm(n,128*self.a3)
        self.aarelu12 = nn.LeakyReLU()
        self.aafc1 = nn.Linear(128*self.a3*int(self.sz1/2)*int(self.sz1/2), 128)
    ...
    def forward(self, x):
        ...
        #    x1[i,:,:,:] = (x1[i,:,:,:] - x1[i,:,:,:].min())/(x1[i,:,:,:].max() - x1[i,:,:,:].min())
        #    x2[i,:,:,:] = (x2[i,:,:,:] - x2[i,:,:,:].min())/(x2[i,:,:,:].max() - x2[i,:,:,:].min())
        ...
        out = self.dropout1(self.relu13(self.bn13(self.fc1(out.view(-1, 128*self.a1*int(self.sz1/2)*int(self.sz1/2))))))
        ...
        out2 = self.adropout1(self.arelu13(self.abn13(self.afc1(out2.view(-1, 128*self.a2*int(self.sz1/2)*int(self.sz1/2))))))
        ...
        out3 = self.aadropout1(self.aarelu13(self.aabn13(self.aafc1(out3.view(-1, 128*self.a3*int(self.sz1/2)*int(self.sz1/2))))))
